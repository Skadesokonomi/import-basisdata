...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_company', 'Sector data', 'fdc_data.industri', 'S', '', '', '', '', 'Parametergruppe til tabel "industri"', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_publicservice', 'Sector data', 'fdc_data.offentlig_service', 'S', '', '', '', '', '', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_road_traffic', 'Sector data', 'fdc_data.vejnet', 'S', '', '', '', '', 'Parametergruppe til tabel "vejnet"', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_bioscore', 'Sector data', 'fdc_data.biodiversitet', 'S', '', '', '', '', 'Parametergruppe til tabel "biodiversitet"', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_human_health', 'Sector data', 'fdc_data.mennesker', 'S', '', '', '', '', 'Parametergruppe til tabel "mennesker"', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_recreative', 'Sector data', 'fdc_data.rekreative_omr', 'S', '', '', '', '', 'Parametergruppe til tabel "rekreative områder"', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_building', 'Sector data', 'fdc_data.bygninger', 'S', '', '', '', '', 'Parametergruppe til tabel "Bygninger"', 10, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_infrastructure', 'Sector data', 'fdc_data.kritisk_infrastruktur', 'S', '', '', '', '', 'Parametergruppe til tabel "kritisk infrastruktur"', 10, ' ');
