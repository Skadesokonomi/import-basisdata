...
ALTER TABLE IF EXISTS afgroede_kategori DROP CONSTRAINT IF EXISTS afgroede_kategori_pkey;
ALTER TABLE IF EXISTS afgroede_kategori DROP CONSTRAINT IF EXISTS fk_afgroede_kategori_afgroedekode ;
ALTER TABLE IF EXISTS afgroede_pris DROP CONSTRAINT IF EXISTS afgroede_pris_pkey;

CREATE TABLE IF NOT EXISTS afgroede_pris (
    priskategori text NOT NULL,
    pris double precision
);

TRUNCATE afgroede_pris;
...
CREATE TABLE IF NOT EXISTS afgroede_kategori (
...
ALTER TABLE ONLY afgroede_pris ADD CONSTRAINT afgroede_pris_pkey PRIMARY KEY (priskategori);
ALTER TABLE ONLY afgroede_kategori ADD CONSTRAINT afgroede_kategori_pkey PRIMARY KEY (afgroedekode);
ALTER TABLE ONLY afgroede_kategori ADD CONSTRAINT fk_afgroede_kategori_afgroedekode FOREIGN KEY (priskategori) REFERENCES afgroede_pris(priskategori);
