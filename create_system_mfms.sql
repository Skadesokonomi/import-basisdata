...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Sektor modeller', 'Models', '', 'G', ' ', ' ', ' ', 'sector_models', ' ', 2, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Oversvømmelsesmodeller', 'Models', ' ', 'G', '', '', '', 'flood_models', ' ', 3, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Generelle modelværdier', 'Models', '', 'G', '', '', '', 'general_models', 'Afsnit, hvor parametre, der bruges i mange forskellige modeller, kan værdisættes', 1, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Offentlig service', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for Offentlig service', 2, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Vej og trafik', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for Vej og trafik', 2, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Kritisk infrastruktur', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for Kritisk infrastruktur', 2, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Bygninger', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for Bygninger', 2, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Økosystemer', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for økosystemer', 4, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Turisme', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for Turisme', 5, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Rekreative områder', 'Sektor modeller', '', 'T', '', '', '', '', 'Skademodeller for Rekreative områder', 5, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Erhverv', 'Sektor modeller', ' ', 'G', '', '', '', '', 'Skademodeller for Erhverv', 5, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_company', 'Sector data', '', 'S', '', '', '', '', 'Parametergruppe til tabel "Erhverv"', 10, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('t_bioscore', 'Sector data', '', 'S', '', '', '', '', 'Parametergruppe til tabel "Økosystemer"', 10, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('f_pkey_t_bioscore', 't_bioscore', 'fid', 'F', '', '', '', '', '', 10, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Personale', 'Erhverv', ' ', 'T', '', '', '', 'q_comp_build', 'Sæt hak såfremt modellen skal identificere de virksomheder som bliver berørt af den pågældende oversvømmelse, og angive antallet af medarbejdere per virksomhed.', 10, 'T');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Bioværdi', 'Økosystemer', '', 'T', '', '', '', 'q_bioscore', 'Sæt hak såfremt modellen skal identificere særlige levesteder for rødlistede arter som bliver berørt i forbindelse med den pågældende oversvømmelseshændelse. Her vises levestederne geografisk på et kort.', 10, 'T');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Infrastruktur', 'Kritisk infrastruktur', '', 'T', '', '', '', 'q_infrastructure', 'Udpegning af oversvømmet kritisk infrastruktur. Den berørte infrastruktur vises geografisk på et kort.  ', 10, 'T');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Off.service', 'Offentlig service', '', 'T', '', '', '', 'q_publicservice', 'Udpegning af oversvømmet kritisk infrastruktur. Den berørte infrastruktur vises geografisk på et kort.  ', 10, 'T');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Landbrug', 'Sektor modeller', '', 'G', '', '', '', '', 'Skademodeller for landbrug', 10, ' ');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('f_pkey_q_tourism', 'q_tourism', 'fid', 'T', '', '', '', '', 'Name of primary keyfield for query', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('f_geom_q_tourism', 'q_tourism', 'geom', 'T', '', '', '', '', 'Field name for geometry column', 10, ' ');
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('f_damage_q_tourism', 'q_tourism', 'skadebeloeb_kr', 'T', '', '', '', '', '', 1, 'T');
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('q_tourism', 'Queries', '
WITH b1 AS (
    SELECT 
        bg.{f_pkey_t_building},
        st_length(st_intersection(ov.{f_geom_Oversvømmelsesmodel},ST_ExteriorRing((ST_Dump(bg.{f_geom_t_building})).geom))) as perimeter_overlap_m,
...
INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Bygningskade', 'Bygninger', '', 'T', '', '', '', 'q_building', 'Skadeberegning for bygninger baseret på perimeter', 11, 'T')
ON CONFLICT (name) DO UPDATE SET value = EXCLUDED.value;

INSERT INTO parametre (name, parent, value, type, minval, maxval, lookupvalues, "default", explanation, sort, checkable) VALUES ('Skade,turisme', 'Turisme', '', 'T', '', '', '', 'q_tourism', 'Sæt hak såfremt der skal beregnes økonomiske tab for overnatningssteder som anvendes til turistformål. De berørte bygninger vises geografisk på et kort.  ', 10, 'T')
ON CONFLICT (name) DO UPDATE SET value = EXCLUDED.value;
