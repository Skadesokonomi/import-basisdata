...
/***************************************************************************
 FDCVectorPolygonDB
                                 A QGIS plugin
 QGIS processing plugin to import polygon vector data as a table into the flood damage database with refactoring
...
class FDCVectorPolygonDB(QgsProcessingAlgorithm):
...
"""
        ...
        sqltxt = xxx.format(schemaname=parameters['schema_flood_data'].strip('"'),tablename=tablename.strip('"'), modelname=modelname,ftt=ftt,rpt=rpt,sct=sct,ye=ye,ap=apt)
    ...
    def name(self) -> str:
        return 'flood_vector_polygon_db'

    def displayName(self) -> str:
        return 'OS2 Flood Damage Cost Import/refactor flood vector polygon to database'
